...
class RiddleAdmin(admin.ModelAdmin):
	...
	filter_horizontal = ['riddler', "tags"]
...
class StoryAdmin(admin.ModelAdmin):
	list_display = ["title", "timestamp", "updated", "show_story"]
	list_filter = ["title", "timestamp", "updated"]
	search_fields = ["title", "story", "timestamp", "updated"]
	filter_horizontal = ['author', "tags", "related_story"]
