...
class all_poems(models.Model):
	...
	poet = models.ManyToManyField(all_authors, blank=True, null=True)
...
class all_riddles(models.Model):
	...
	riddler = models.ManyToManyField(all_authors, blank=True, null=True)
	tags = models.ManyToManyField(taggers, blank=True, null=True)
...
class all_stories(models.Model):
	...
	author = models.ManyToManyField(all_authors, blank=True, null=True)
	tags = models.ManyToManyField(taggers, blank=True, null=True)
