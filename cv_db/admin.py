...
class dbModelAdmin(admin.ModelAdmin):
    list_display = ['id',"cat_0","cat_1","cat_2","cat_3","cat_4","cat_5","cat_6","cat_7","cat_8","cat_9", "updated", "timestamp"]
    ...
    list_editable = ["cat_0","cat_1","cat_2","cat_3","cat_4","cat_5","cat_6","cat_7","cat_8","cat_9"]
    class Meta:
        model = document_data
