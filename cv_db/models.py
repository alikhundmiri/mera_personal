...
class document_data(models.Model):
    ...
    cat_1 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_2 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_3 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_4 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_5 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_6 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_7 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_8 = models.CharField(max_length=1000, blank=True, null=True, default="")
    cat_9 = models.CharField(max_length=1000, blank=True, null=True, default="")
